...
**TIP CALCULATOR** is an aplication where you can calculate your bill total count with tip included and divided by x number of people. 
...
- **You can divide your total bill with people you want**

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🚀 Live Demo <a name="live-demo"></a>

- [Live Demo Link](https://shm04.github.io/tip-calculator/)
...
```
  cd my-folder
  git clone git@github.com:myaccount/tip-calculator.git
```
